...
public final class DemoDetailsList {
    ...
    public static final DemoDetails[] DEMOS = {
            ...
            new DemoDetails(R.string.basic_map_fragment,
                    R.string.basic_map_fragment_description,
                    BasicMapFragmentContainerActivity.class),
            ...
            new DemoDetails(R.string.my_location_activity,
                    R.string.my_location_description,
                    MapsLocationActivity.class),
            new DemoDetails(R.string.my_location_fragment,
                    R.string.my_location_fragment_description,
                    MapsLocationFragmentContainerActivity.class),
            new DemoDetails(R.string.map_in_pager_demo_label,
                    R.string.map_in_pager_demo_description,
                    MapInPagerDemoActivity.class),
            new DemoDetails(R.string.multiple_pager,
                    R.string.multiple_pager_description,
                    MultipleMapsPagerActivity.class),
