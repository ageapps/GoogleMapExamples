...
/**
 * This activity shows how to save the state of a MapLocationFragment when the activity is recreated, like
...
public class SaveStateDemoActivity extends AppCompatActivity {
    ...
    /**
     * Example of a custom {@code MapLocationFragment} showing how the position of a marker and other
     * custom
    ...
    public static class SaveStateMapFragment extends SupportMapFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null) {
                ...
                // Extract the state of the MapLocationFragment:
